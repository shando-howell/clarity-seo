...
// Make a safe data type enum for all API paths
export enum ApiPath {
    Webhook = "/api/webhook",
}
    ...
    handler: httpAction(async (ctx, req) => {
        ...
        try {
            ...
            if (!job) {
                ...
                return new Response(`No job found for ID: ${jobId}`, {
                    status: 404,
                });
            }
            ...
            console.log(`Analysis scheduled for job ${job._id}, webhook returning immediately`);
